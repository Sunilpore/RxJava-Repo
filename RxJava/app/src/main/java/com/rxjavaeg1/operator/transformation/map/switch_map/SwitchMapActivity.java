...
public class SwitchMapActivity extends AppCompatActivity implements SwitchMapAdapter.OnPostClickListener {

    private static final String TAG = "SwitchMapAct";
    ...
    private SwitchMapAdapter adapter;
        ...
        ServiceGenerator.getRequestApi()
                ...
                .subscribe(new Observer<List<Post>>() {
                    ...
                    public void onNext(List<Post> posts) {
                        Log.d(TAG, "onNext: retrieve post.");
    ...
    private void initRecyclerView(){
        adapter = new SwitchMapAdapter(this);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setAdapter(adapter);
    }

    private void navViewPostActivity(Post post){
        Intent intent = new Intent(this, SwitchMapSecondActivity.class);
